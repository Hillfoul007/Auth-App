// Booking helpers that work with MongoDB backend API
...
export const bookingHelpers = {
  ...
  // Get pending bookings for riders
  ...
  // Clear all user bookings (for demo/testing purposes)
  async clearUserBookings(userId: string) {
    try {
      // This would typically be an admin function
      // For now, we'll just return success since we don't have this endpoint
      console.log(
